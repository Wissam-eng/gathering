...
@section('content')
    ...
    <div class="container" style="width: 50%;">
            ...
            @if ($card)
                ...
                <div style="display: flex; gap: 10px;">
                    @foreach ($card['images'] as $image)
                        <img src="{{ asset($image) }}" alt="Image" style="width: 100px; height: 100px; object-fit: cover;">
                    @endforeach
                </div>
            @endif
        ...
        <!-- form controls -->
        <form class="space-y-5" method="POST" action="{{ route('photo_gallery.update', $card['code']) }}"
